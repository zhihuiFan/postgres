...
extern PGARR(Oid) *extract_grouping_ops(List *groupClause);
extern PGARR(Oid) *extract_grouping_collations(List *groupClause, List *tlist);
extern PGARR(AttrNumber) *extract_grouping_cols(List *groupClause, List *tlist);
